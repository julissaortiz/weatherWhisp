...
//funtion for handling form submission
...
let getCoordinates = (city) => {
  ...
  let apiUrl =
    ...
    city +
    "&limit=3&appid=8b6438d6eec5f09272a77eff161e0e8b";
...
const getWeather = (location) => {
  ...
  let apiUrl = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&units=imperial&appid=8b6438d6eec5f09272a77eff161e0e8b`;
...
const getForecast = (location) => {
  ...
  let apiUrl = `https://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&units=imperial&appid=8b6438d6eec5f09272a77eff161e0e8b`;
